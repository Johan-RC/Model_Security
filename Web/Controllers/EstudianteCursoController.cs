...
namespace Web.Controllers
{
    ...
    {
        private readonly IEstudianteCursoBusiness _FormModuleBusiness;
        ...
        public EstudianteCursoController(IEstudianteCursoBusiness FormModuleBusiness, ILogger<EstudianteCursoController> logger)
        {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(IEnumerable<Entity.DTOs.EstudianteDTO>), 200)]
        ...
        /// <response code="500">Error interno del servidor</response>
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(Entity.DTOs.EstudianteDTO), 200)]
        ...
        /// <response code="500">Error interno del servidor</response>
        [HttpPost]
        [ProducesResponseType(typeof(Entity.DTOs.EstudianteDTO), 201)]
        [ProducesResponseType(400)]
        [ProducesResponseType(500)]
        public async Task<IActionResult> CreateFormModule([FromBody] Entity.DTOs.EstudianteDTO FormModuleDto)
        {
            try
            {
